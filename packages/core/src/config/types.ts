 ...
 */
export interface AgorIDETunnelSettings {
  /** VS Code Tunnel name (`code tunnel status` 命令显示的名称) */
  name?: string;
...
export type ConfigKey =
  ...
  | `ide.vscode.tunnel.${keyof AgorIDETunnelSettings}`
